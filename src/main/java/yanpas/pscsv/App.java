...
class Retriever
{
	...
	public Retriever(String user, String password, String db_name, String address) throws SQLException 
	{
	...
	private void exportTable(String table_name) throws SQLException, IOException, Exception
	{
		...
		FileOutputStream fout = new FileOutputStream(out_dir+"/"+table_name+".csv");
	...
	private void packAll()
	{
		...
		but.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				try
				{
					Retriever r = new Retriever(username_t.getText(),
							password_t.getText(),
							db_name_t.getText(),
							addr_t.getText());
				...
				{
					e1.printStackTrace();
					JOptionPane.showMessageDialog(Frame.this, "SQL exception caught:\n"+e1.getMessage()
					+ "\nStack trace was written to console","DB Error", JOptionPane.ERROR_MESSAGE);
					return;
				} catch (IOException e1)
				{
					e1.printStackTrace();
					JOptionPane.showMessageDialog(Frame.this, "Export exception caught:\n"+e1.getMessage()
					+ "\nStack trace was written to console","I/O Error", JOptionPane.ERROR_MESSAGE);
					return;
				} catch (Exception e1)
				{
					JOptionPane.showMessageDialog(Frame.this, "Exception caught:\n"+e1.getMessage()
					,"Some other kind of error", JOptionPane.ERROR_MESSAGE);
					return;
				}
				JOptionPane.showMessageDialog(Frame.this, "Completed successfully","Completed", JOptionPane.INFORMATION_MESSAGE);
			}
		});
		pack();
	}
...
public class App 
{
    public static void main( String[] args )
    {
    	...
    	{
            try {
            	Retriever r = new Retriever(args[1],args[2],args[3],args[4]); //("kek", "1", "world", "127.0.0.1:5432");
            	r.exportAll("csvs");
            }
    		catch (Exception e)
            {
